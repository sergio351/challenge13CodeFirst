...
namespace Challenge13CodeFirst.Controllers
{
    public class ProductosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Categoria,Fecha")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Categoria,Fecha")] Producto producto)
        {
            if (id != producto.Id)
            {
                return NotFound();
